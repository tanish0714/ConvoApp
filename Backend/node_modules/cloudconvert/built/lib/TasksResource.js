...
class TasksResource {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.cloudConvert.axios.get(`tasks/${id}`, {
                baseURL: this.cloudConvert.useSandbox
                    ...
                    : `https://${this.cloudConvert.region
    ...
    upload(task, stream, filename = null, size = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (stream instanceof fs_1.ReadStream) {
                fileOptions.knownLength = (0, fs_1.statSync)(stream.path).size;
            }
            formData.append('file', stream, fileOptions);
            return yield axios_1.default.post(task.result.form.url, formData, {
                maxContentLength: Infinity,
                maxBodyLength: Infinity,
                headers: Object.assign(Object.assign({}, (formData.hasKnownLength()
