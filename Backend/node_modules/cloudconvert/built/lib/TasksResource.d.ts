...
export type ImportOperation = ImportUrl | ImportUpload | ImportBase64 | ImportRaw | ImportS3 | ImportAzureBlob | ImportGoogleCloudStorage | ImportOpenStack | ImportSFTP;
export type TaskOperation = TaskConvert | TaskOptimize | TaskWaterMark | TaskCapture | TaskThumbnail | TaskMerge | TaskArchive | TaskCommand | TaskMetadata | TaskMetadataWrite;
...
export interface TaskWaterMarkData {
    ...
    font_color?: string;
    font_name?: 'Andale Mono' | 'Arial' | 'Arial Black' | 'Arial Bold' | 'Arial Bold Italic' | 'Arial Italic' | 'Courier New' | 'Courier New Bold' | 'Courier New Bold Italic' | 'Courier New Italic' | 'Georgia' | 'Georgia Bold' | 'Georgia Bold Italic' | 'Georgia Italic' | 'Helvetica' | 'Helvetica Bold' | 'Helvetica BoldOblique' | 'Helvetica Narrow Bold' | 'Helvetica Narrow BoldOblique' | 'Helvetica Oblique' | 'Impact' | 'Times New Roman' | 'Times New Roman Bold' | 'Times New Roman Bold Italic' | 'Times New Roman Italic' | 'Trebuchet MS' | 'Trebuchet MS Bold' | 'Trebuchet MS Bold Italic' | 'Trebuchet MS Italic' | 'Verdana' | 'Verdana Bold' | 'Verdana Bold Italic' | 'Verdana Italic';
...
export default class TasksResource {
    ...
    upload(task: Task | JobTask, stream: Stream, filename?: string | null, size?: number | null): Promise<any>;
